...
function renderVideoCard(brandUrl,brandTitle,nameBrand,brandprice){

    var MaiGrid = document.getElementById("brand-grid")
    var MainCard = document.createElement("div");
    var ImgCard = document.createElement("img");
    var title = document.createElement("h3");
    var brandName = document.createElement("p");
    var branPrice = document.createElement("p");
    
    var MainHeadTitle =document.getElementById("man-women")
    MainHeadTitle.className ="man-women"
    MainHeadTitle.innerText="Clothing for Men and Women" 
    
    MainCard.appendChild(ImgCard);
    MainCard.appendChild(title);
    MainCard.appendChild(brandName);
    MainCard.appendChild(branPrice);
    
    title.innerText = brandTitle;
    brandName.innerText =nameBrand;
    branPrice.innerText = brandprice;
    
 
    MainCard.className = "brand-card";
    ImgCard.className = "brand-img";
    title.className = "brand-title";
    brandName.className = "brand-name";
    branPrice.className = "brand-price";
    
    ImgCard.src =brandUrl;
    console.log(MainCard)
    MaiGrid.appendChild(MainCard)
    
}
for(var pos=0; pos < productList.length; pos++ ){
    renderVideoCard(productList[pos].photos,productList[pos].name, productList[pos].brand, productList[pos].price);
}
